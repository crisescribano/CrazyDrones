...
class CF_model():
    ...
    def __init__(self):
        ...
        rospy.init_node("dynamic_model_vel", anonymous=True)
    ...
    # Callback function
    ###########################
    def NewInfoAttitude(self, twist_msg):
        ##############!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
        ### DUDA EN EL CODIGO DEL SERVER DE LO QUE ES m_X_trim
    	self.desired_att[0] = twist_msg.linear.y + m_roll_trim
        self.desired_att[1] = twist_msg.linear.x + m_pitch_trim
        self.desired_ang_vel[2] = twist_msg.angular.z
        self.desired_thrust = twist_msg.linear.z
        rospy.loginfo("Received new hover info" )
